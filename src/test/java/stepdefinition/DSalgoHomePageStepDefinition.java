...
//
	...
	@When("The user clicks datastructures dropdown {string} and select")
	public void the_user_clicks_datastructures_dropdown_and_select(String string) {
	    homepage.dropdown(string);
		LoggerLoad.info("user clicks the DS dropdown");

	}
	@Then("The error message {string} appears in homepage")
	public void the_error_message_appears_in_homepage(String msg) {
		homepage.alertmsg(msg);
	...
	@When("The user clicks on Get Started link on homepage {string} without SigningIn")
	public void the_user_clicks_on_get_started_link_on_homepage_without_signing_in(String string) {
